...
# .macos/macpref.sh
# sets up all my macos preferences
...
sudo scutil --set ComputerName "catpro"
sudo scutil --set HostName "catpro"
sudo scutil --set LocalHostName "catpro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "catpro"
